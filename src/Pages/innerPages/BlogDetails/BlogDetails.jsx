                ...
                <Container>
                    <Row>
                        <Col md={8} className="mt-5">
                            <img src={Layers} alt="" className='img-fluid' />
                            ...
                            <h3 className='mt-3 fw-bold'>Back To School Social-Emotional Basics:
                                Relationship, Rhythm, Release</h3>
                            <p className='blog_font_size'>As our elementary students head back to school in person, in this very new way, there will be many emotions stirred up in them. Alarm. Frustration. Worry. Excitement.</p>

                            <p className='blog_font_size'>   And this will be mirrored by what we, as adults, may also be experiencing. For our teachers, on top of what they will be emotionally experiencing themselves, they are being called to be the caring leaders that guide our students to a place where they can learn together.</p>
